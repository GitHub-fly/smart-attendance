 ...
 **/
 public interface SysClazzRepository extends JpaRepository<SysClazz, Integer> {
    ...
    * 根据班级名称查询学生信息和假条信息
    */
   @Query("SELECT NEW com.soft1851.springboot.smart.attendance.model.vo.ClazzNoteVo(n.pkNoteId, u.pkSysUserId, u.sysUserName, u.sysJobNumber, n.status, n.type, n.gmtCreate) " +
           "FROM SysNote n " +
           "LEFT JOIN SysUser u " +
